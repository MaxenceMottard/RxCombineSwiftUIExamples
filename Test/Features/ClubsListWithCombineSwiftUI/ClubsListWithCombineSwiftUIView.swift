//
//  ClubsListWithCombineSwiftUIView.swift
//  Test
//
...
struct ClubsListWithCombineSwiftUIView<ViewModel: ClubsListWithCombineSwiftUIViewModelling>: View {
...
#Preview {
    class ClubsListWithCombineSwiftUIViewModellingMock: ClubsListWithCombineSwiftUIViewModelling {
        var clubs: [Club]
        init(clubs: [Club]) {
            self.clubs = clubs
        }
    ...
    let viewModel = ClubsListWithCombineSwiftUIViewModellingMock(
        clubs: [
    ...
    return NavigationStack {
        ClubsListWithCombineSwiftUIView {
            viewModel
        }
    }
}
